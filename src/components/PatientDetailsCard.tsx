...
export const PatientDetailsCard: React.FC<PatientDetailsCardProps> = ({ patient }) => (
  <Paper sx={{
    ...
    <Avatar src={patient.profilePicture} alt={patient.name} sx={{ width: 96, height: 96, mb: 2 }} />
    ...
    <Box sx={{ width: '100%', mb: 2 }}>
      ...
      <Typography variant="body1" sx={{ fontWeight: 500 }}>{patient.insuranceType || 'Sunrise Health Assurance'}</Typography>
    </Box>
